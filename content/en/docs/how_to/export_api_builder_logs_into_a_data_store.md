...
1. **{{% variables/apibuilder_prod_name %}} Command Line Interface (CLI)** \- Refer to the [Getting Started With {{% variables/apibuilder_prod_name %}}](/docs/getting_started/#getting-started). Once {{% variables/apibuilder_prod_name %}} CLI is installed, you can use it to create a new project and start the {{% variables/apibuilder_prod_name %}} project.
