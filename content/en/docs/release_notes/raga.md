...
* [#5583:](#5583) New {{% variables/apibuilder_prod_name %}} CLI for {{% variables/platform_prod_name %}}

## Fixes

* [#5626:](#5626) Concurrent writes to same model file causes server to crash
* [#5641:](#5641) Error "Not possible to find intersection inside of the rectangle" when saving flow
