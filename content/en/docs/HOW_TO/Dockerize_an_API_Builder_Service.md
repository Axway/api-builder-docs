...
2. **Production Deployment**: Because the image is built in production mode, the service is no longer editable. The {{% variables/apibuilder_prod_name %}} console will not be available.
