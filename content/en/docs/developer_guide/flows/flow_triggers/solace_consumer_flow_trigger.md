...
| Queue acknowledge mode | String | The type of message acknowledgement required from the client. Only applies to queues. If "Client", then the client must use the Solace Acknowledge flow-node. | Selector, String | No |
