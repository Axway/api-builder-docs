...
{{% alert title="Note" color="primary" %}}Note that "/C=US/O=Axway/CN={{% variables/apibuilder_prod_name %}}" is the Subject Distinguished Name. You can change it to whatever you require.{{% /alert %}}
