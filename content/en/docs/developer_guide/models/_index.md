...
1. Calls the module's `createModel(name`, `schema)` method (or another `Model` method), passing in the name of the model as the first parameter and an object defining the model schema as the second parameter.
