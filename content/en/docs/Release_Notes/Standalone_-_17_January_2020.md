...
* [#4899:](#4899) Add plugin init command to CLI and new plugin SDK

* [#6139:](#6139) Support loading data connectors that fail to connect

* [#6152:](#6152) Add support for installing Components

## Fixes

* [#6142:](#6142) Restart signal (SIGUSR2) causes exception

* [#6174:](#6174) Add examples link to SDK
